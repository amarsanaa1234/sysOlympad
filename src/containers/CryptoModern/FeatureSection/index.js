...
import { Features, Top } from "common/data/CryptoModern";
    ...
    <FeatureSectionWrapper id="key-features">
      <Container>
        ...
        <Box {...sectionHeader} className="sectionHeader">
          <Text
            content={<div className="Title">Ерөнхий ивээн тэтгэгч</div>}
            {...sectionSubTitle}
          />
          <Heading
            content={
        ...
        <PricingPolicy>
          <Box className="row" {...row}>
            {Top.map((feature, index) => (
              <Box className="col_top" {...col} key={index}>
                <FeatureBlock
        ...
        <Box {...sectionHeader} className="sectionHeader">
          <Text
            content={<div className="Title">Ивээн тэтгэгч</div>}
            {...sectionSubTitle}
          />
          <Heading
            content={
              <div style={{ fontFamily: "Roboto", color: "#30D4FE" }}>
                Sys&CoTech клубээс зохион байгуулж буй "Програмчлалын Олимпиад -
                2022" тэмцээний ивээн тэтгэгч байгууллагууд
              </div>
            }
            {...sectionTitle}
          />
